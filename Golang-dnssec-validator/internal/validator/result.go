...
type RecordValidation struct {
	...
	Wildcard              bool       `json:"wildcard,omitempty"`                // Answer was synthesized from a wildcard
	...
	Target                string     `json:"target,omitempty"`                  // authenticated alias target (CNAME/DNAME) — RA6X-014/015
	SynthesizedFrom       string     `json:"synthesized_from,omitempty"`        // DNAME owner the CNAME was synthesized from — RA6X-014
	Error                 string     `json:"error,omitempty"`
}
